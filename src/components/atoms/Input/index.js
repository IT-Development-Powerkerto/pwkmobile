...
const Input = ({ placeholder, type, value, onChangeText, editable, noPad, multiline }) => {
    ...
    return (
        <View>
            <TextInput style={styles.input(borderColor, noPad)} multiline={multiline} placeholderTextColor={colors._gray} placeholder={placeholder} editable={editable} onFocus={onFocus} onBlur={onBlur} value={value} onChangeText={onChangeText} />
